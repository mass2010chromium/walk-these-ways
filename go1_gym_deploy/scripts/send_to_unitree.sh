...
rsync -av -e ssh --exclude=*.pt --exclude="*.mp4" --exclude="*.swp" $PWD/../../go1_gym_deploy $PWD/../../RL_Environment $PWD/../../MPC_Controller $PWD/../../hydra $PWD/../../omegaconf $PWD/../../rsl_rl $PWD/../../runs $PWD/../setup.py unitree@192.168.123.15:/home/unitree/go1_gym
